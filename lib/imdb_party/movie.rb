module ImdbParty
  class Movie
    attr_accessor :imdb_id, :title, :directors, :writers, :tagline, :company, :plot, :runtime, :rating, :poster_url, :release_date, :certification, :genres, :actors, :trailers, :raw
    ...
    def initialize(options={})
      ...
      # parse directors
      @directors = options["directors_summary"] ? options["directors_summary"] : []

      # parse directors
      @writers = []
      @writers = options["writers_summary"] ? options["writers_summary"] : []

      # parse actors
      @actors = []
      @actors = options["cast_summary"] ? options["cast_summary"] : []
